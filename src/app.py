...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork and skills in a competitive soccer environment",
    ...
    "Art Studio": {
        "description": "Create paintings, sketches, and mixed-media works in a creative studio",
